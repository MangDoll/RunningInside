...
ACollisionDetection::ACollisionDetection()
{
	...
	CollisionBox->OnComponentBeginOverlap.AddDynamic(this, &ACollisionDetection::OnOverlapBegin);
}
...
void ACollisionDetection::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (RunningInsideCharacter)
	{
		UGameplayStatics::PlaySoundAtLocation(this, RespwanSound, GetActorLocation());
		RunningInsideCharacter->Respawn();
